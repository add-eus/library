...
export default defineComponent({
    ...
    render() {
        ...
        /*const range = Math.abs(this.scrollMin - this.scrollMax);
        const step = (this.scroll + this.scrollMin) / range;
        console.log(this.scrollMin, this.scrollMax, this.internalOptions.length, step);*/
        nodes = nodes.concat(
